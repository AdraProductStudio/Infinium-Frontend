  ...
  return (
    <div className="authPage">
      <div className="authCard">
        ...
        <p className="authSubtitle">Start reviewing smarter today</p>
          ...
          <div className="authField">
            ...
            <div className="authInputWrap">
              <input
                ...
                autoComplete="new-password"
              />
              <button type="button" className="authEyeBtn" onClick={() => setShowConfirmPassword((v) => !v)}>
                {showConfirmPassword ? (
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
                    <path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19"/>
        ...
        <button className="authGoogleBtn" onClick={handleGoogle}>
        ...
        <p className="authFooter">
          ...
          <Link href="/login" className="authLink">Sign in</Link>
        </p>
      </div>
    </div>
  );
